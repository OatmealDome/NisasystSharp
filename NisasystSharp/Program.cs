    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (args.Length != 2)
            {
                ...
                Console.WriteLine("Example: NisasystSharp Mush/ActorDb.release.byml C:\\Blitz\\ActorDb.Release.byml");
            ...
            using (StreamReader streamReader = new StreamReader(fileStream))
            {
                ...
                if (fileStream.Length <= 8)
                {
                    ...
                    Console.WriteLine("The file is too small to be a nisasyst container");
                    return;
                }
